...
public class OpenApiConfiguration {
    private static final Map<String, EndpointDoc> ENDPOINTS = Map.ofEntries(
            ...
            doc("DELETE", "/api/v1/materials/{materialId}", "자료 업로드", "PDF 자료 삭제", "소유한 PDF와 연관 데이터를 즉시 삭제하고 원본 GCS 객체는 안전하게 비동기 정리합니다.", false),
            ...
            doc("DELETE", "/api/v1/exam-resources/{examResourceId}", "자료 업로드", "기출 PDF 삭제", "소유한 기출 PDF와 연관 데이터를 즉시 삭제하고 원본 GCS 객체는 안전하게 비동기 정리합니다.", false),
